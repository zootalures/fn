...
The series will demonstrate some of the core Fn capabilities using a number of examples. We'll show examples in most major languages. This is a great place to start!
